...
DOT_COLORS = [  0x00400000,   # red       0x200000  0
                ...
                0x00F00000,   # StrongRed 0x000000  10
                0x0000F000,   # StrongGrn 0x000000  11
                0x000000F0,   # StrongBlu 0x000000  12
...
while 1:
    ...
    if streeState:
        ...
        if data[0] == stressConfirm:
            ...
            if data[0] == stressSignal:
                sendReply(s, stressResp.to_bytes(1,byteorder='big'), addr)
                print('got a stree call')
                # already in stress state
                os.system('aplay help4.wav &')
            else:
                sendReply(s,data,addr)
            #continue
    else:
    ...
    if data[0] == 0x72:  #'r' means error or disabled red
            for i in range(LED_COUNT):
